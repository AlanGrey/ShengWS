...
/*TimerTextView v = (TimerTextView) getView(R.id.button1);
...
public class TimerTextView extends TextView {
    ...
    private long time;
    private int enabledColor = getResources().getColor(R.color.holo_green_dark);//默认
    private int disEnabledColor = getResources().getColor(R.color.dark_grey);//默认
    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (time < 0) {
                ...
                TimerTextView.this.setTextColor(enabledColor);
                clearTimer();
            }
        }
    };
    ...
    public void startTimer() {
        ...
        this.setTextColor(disEnabledColor);
    ...
    public void setColor(int enabledColor, int disEnabledColor) {
        this.enabledColor = enabledColor;
        this.disEnabledColor = disEnabledColor;
    }
