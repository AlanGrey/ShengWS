...
public class AssetsDatabaseManager {
    ...
    private static String databasepath = "/data/data/%s/local_databases"; // %s is packageName
    ...
    public SQLiteDatabase getDatabase(String dbfile) {
        ...
        SharedPreferences dbs = context.getSharedPreferences("AssetsDatabasePref", 0);
